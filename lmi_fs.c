...
fs_open(char *name)
{
    ...
    //
    if(strncmp(name, "/cgi-bin/toggle_temp", 19) == 0)
    {   
        static char pcBuf[4];
        //char temp = '8';
        //
    ...
    //
    if(strncmp(name, "/tempstate?id", 12) == 0)
    {
        static char pcBuf[4];
        static int count = 0;
        char temp = 8;
        ...
        usnprintf(pcBuf, 4, "7");
          ...
          usnprintf(pcBuf, 4, "20");
        
        count++;
        //usnprintf(pcBuf, 30, "Temperature is: %d", temp);
